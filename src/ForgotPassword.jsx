...
const ForgotPassword = () => {
  ...
  return (
    <div className="flex flex-col justify-center md:p-[30px] rounded-[16px] align-center w-[80%] md:w-[70%] lg:w-[50%] dark:bg-black md:border-[var(--secondary-color)] md:border-[2px]  gap-[20px] my-[20px]">
