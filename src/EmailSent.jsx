...
const EmailSent = () => {
  return (
    <div className="flex flex-col justify-center md:p-[30px] rounded-[10px] align-center w-[80%] md:w-[70%] lg:w-[50%]] dark:bg-black md:bg-[var(--primary-color)] gap-[20px] my-[20px]">
